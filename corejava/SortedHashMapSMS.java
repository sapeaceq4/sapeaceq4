...
public class SortedHashMapSMS {
	public static void main(String args[]) throws ParseException { 
		...
		codenames.put("110", "Spark"); 
		codenames.put("108", "Pabla"); 
		codenames.put("103", "Kestrel"); 
		codenames.put("104", "Merlin");
		codenames.put("170", "Tiger"); 
		codenames.put("160", "Michle"); 
		codenames.put("107", "Doly"); 
