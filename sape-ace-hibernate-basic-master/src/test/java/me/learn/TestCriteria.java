...
public class TestCriteria {
	...
	public void testAddressSAves(){
		...
		address.setLine1("Sector 22");
		address.setLine2("----");
		address.setPin("122015");
		Session session = sessionFactory.openSession();
	...
	public void loadAddress(){
		testAddressSAves();
		Session session = sessionFactory.openSession();
		Address add=session.load(Address.class,0L);
	...
	private static void createSessionFactory(){
		...
		.build();
		try {
			sessionFactory = new MetadataSources( registry ).addAnnotatedClass(Address.class).addAnnotatedClass(Participant.class).addAnnotatedClass(Trainer.class).addAnnotatedClass(Skill.class)
