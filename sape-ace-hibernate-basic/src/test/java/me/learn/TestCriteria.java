...
import com.sapient.hibernate.AddressSPK;
import com.sapient.hibernate.UserSPK;
...
public class TestCriteria {
	...
	public void testOneToOne() {
		...
		user.setName("name");
		AddressSPK addr = new AddressSPK();
	...
	private static void createSessionFactory(){
		...
		try {
			sessionFactory = new MetadataSources( registry ).addAnnotatedClass(Participant.class).addAnnotatedClass(Trainer.class).addAnnotatedClass(Skill.class)
					.addAnnotatedClass(UserSPK.class).addAnnotatedClass(AddressSPK.class).buildMetadata().buildSessionFactory();
		}
		catch (Exception e) {
			e.printStackTrace();
