...
import org.om.aec.concurrency.exchanger.BarrierImpl;
import org.om.aec.concurrency.exchanger.IBarrier;
...
public class CyclicBarrierTest 
{
	public static void main(String[] args)
	{
		...
		IBarrier barrier = new BarrierImpl(2, ()->{
...
class CycleRider implements Runnable
{
	...
	public CycleRider(String id, IBarrier barrier, ScoreBoard scoreBoard)
	{
		this.id = id;
